...
<h2>Technology I study and use daily
  ...
  [![My Skills](https://skillicons.dev/icons?i=dotnet,cs,wasm,c,js,jquery,ts,angular,npm,html,css,sass,bootstrap,git,docker,rabbitmq,postman,regex,mysql,postgres,sqlite,selenium&perline=10)](https://skillicons.dev)
