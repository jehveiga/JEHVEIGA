...
<h2>Technology I study and use daily
  ...
  [![My Skills](https://skillicons.dev/icons?i=visualstudio,dotnet,azure,cs,wasm,c,js,jquery,ts,angular,npm,html,css,sass,bootstrap,git,docker,nginx,rabbitmq,kafka,postman,regex,mysql,postgres,sqlite,redis,selenium,linux,debian,ubuntu&perline=10)](https://skillicons.dev)
